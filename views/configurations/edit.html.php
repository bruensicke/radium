<ul class="breadcrumb">
	...
	<li class="active"><?=$this->title(sprintf('Edit configuration: %s', $configuration->name)); ?></li>
	<li class="pull-right"><?=$this->html->link('cancel', array('library' => 'radium', 'action' => 'view', 'args' => array('id' => (string) $configuration->_id)));?></li>
</ul>
